...
function () {
  ...
  View.prototype.bindMap = function (fragment) {
...
function (_super) {
  ...
  function UserForm() {
    ...
    _this.eventsMap = function () {
      return {
        '.set-age:click': _this.onSetAge,
        '.set-name:click': _this.onSetName,
        '.save:click': _this.onSave
      };
    };
...
},{"./View":"src/views/View.ts","./UserShow":"src/views/UserShow.ts","./UserForm":"src/views/UserForm.ts"}],"src/models/Models.ts":[function(require,module,exports) {
"use strict";
...
/** @class */
function () {
  function APISync(rooLink) {
    var _this = this;

    this.rooLink = rooLink;

    this.fetch = function (id) {
      return axios_1.default.get(_this.rooLink + "/" + id);
    };

    this.save = function (data) {
      console.log(_this.rooLink);
      var id = data.id;
      console.log(id);

      if (typeof id === 'number') {
        return axios_1.default.put(_this.rooLink + "/" + id, data);
      } else {
        return axios_1.default.post(_this.rooLink, data);
      }
    };
  }
...
function () {
  function Attributes(data) {
    ...
    this.set = function (props) {
      Object.assign(_this.data, props);
    };
...
function () {
  function Collection(rootUrl, deserialize) {
    ...
    this.models = [];
    this.evetns = new Eventing_1.Eventing();
  }
  ...
  Collection.prototype.fetch = function () {
    ...
    axios_1.default.get(this.rootUrl).then(function (res) {
      res.data.forEach(function (entry) {
        _this.models.push(_this.deserialize(entry));
      });
    });
...
function (_super) {
  ...
  User.createUser = function (data) {
    return new User(new Eventing_1.Eventing(), new APISync_1.APISync(rootUrl), new Attributes_1.Attributes(data));
  };

  User.createUserCollection = function () {
    return new Collection_1.Collection(rootUrl, function (entry) {
...
exports.User = User;
},{"./Models":"src/models/Models.ts","./Eventing":"src/models/Eventing.ts","./APISync":"src/models/APISync.ts","./Attributes":"src/models/Attributes.ts","./Collection":"src/models/Collection.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
if (root) {
  var userInfo = new UserEdit_1.UserEdit(root, user);
  userInfo.render();
} else {
